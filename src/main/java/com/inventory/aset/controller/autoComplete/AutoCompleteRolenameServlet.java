 ...
 * @author newbiecihuy
 */
@WebServlet(name = "AutoCompleteRolenameServlet", urlPatterns = {"/autoCompleteRolenameServlet"})
public class AutoCompleteRolenameServlet extends HttpServlet {
...
//       
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String paramName = "";
            String value = "";
            System.out.println("doGet AutoCompleteRolenameServlet");
            String varName = request.getParameter("term").toLowerCase();
            System.out.println("Entered");
            System.out.println("varName" + varName);
            String json = "";

            List<EntityUsers> isi_roleName = usersDao.findByRoleName(varName);
            System.out.println("isi isi_roleName.getResultList()" + isi_roleName);

            JSONArray array = new JSONArray();
            json = new Gson().toJson(isi_roleName);

            response.getWriter().write(EncryptionUtil.upperCaseFirst(json));

            JSONObject rows = new JSONObject();
            rows.put("results", isi_roleName.size());
            rows.put("rows", array);
