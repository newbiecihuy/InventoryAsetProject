            ...
            <form id="form_add_supplier" name="form_add_supplier" method="POST" action="">
                ...
                <div class="box-body">
                    <div class="form-group w-75">
                        ...
                        <input type="text" name="supplier_name" id="supplier_name" class="form-control-static sw uppercase" value="<%-- out.println(supplier_name);--%>" />
                        <input type="hidden" name="supplier_id" id="supplier_id" value="<%--out.println(supplier_id);--%>"/>
                        <input type="hidden" name="action_insert_supp" id="action_insert_supp"  class="form-control-static sw uppercase"/>
                        <input type="hidden" name="action_edit_supp" id="action_edit_supp"  class="form-control-static sw uppercase" value="<%--out.println(request.getParameter("action_edit_supp"));--%>"/>
                        <input type="hidden" name="action_delete_supp" id="action_delete_supp"  class="form-control-static sw uppercase"/>
                        <span class="required-server"> </span>
                    </div> 
                    <div class="form-group w-75">
                        <label for="supplier_code" class="req">Supplier Code&nbsp;:</label>
                        <input type="text" name="supplier_code" id="supplier_code"  placeholder="Suplier Code" class="form-control-static sw uppercase" value="<%--out.println(supplier_code);--%>"/>
                        <span class="required-server"> </span>
                    </div>
                    <div class="form-group w-75">
                        <label for="address_supplier" class="req">Address&nbsp;:</label>
                        <textarea class="form-control"  name="address_supplier" id="address_supplier"  placeholder="Adress"  class="form-control-static sw uppercase"><%-- out.println(address_supplier);--%></textarea>
                        <span class="required-server"> </span>
                    </div>
                    <div class="form-group w-50">
                        <label for="contact_suplier_name" class="req">Contact Name &nbsp;:</label>
                        <input type="text" name="contact_suplier_name" id="contact_suplier_name" class="form-control-static sw uppercase" data-required="true" value="<%--out.println(contact_suplier_name);--%>" />
                        <span class="required-server"> </span>
                    </div>
                    <div class="form-group w-50">
                        <label for="cotact_suplier_num" class="req">Contact Number &nbsp;:</label>
                        <input type="text" name="cotact_suplier_num" id="cotact_suplier_num"  class="required ui-widget-content form-control-static uppercase" value="<%--out.println(cotact_suplier_num);--%>"/>
                        <span class="required-server"> </span>
                    </div>
                    <div class="form-group w-50">
